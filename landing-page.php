...
<?php get_header('landing'); ?>
  <main>
    <section id="hero" class="landing-hero" style="background-image: url(&quot;/public/images/full-hero.png&quot;)">
      <div class="landing-hero__container landing-container">
        <div class="landing-hero__content">
          <h1>Get a <span>Free Quote</span> Today</h1>
          <p>
            Smart tech, superior cleaning, and savings <br />
            you’ll love.
          </p>
          <h2>Sign a Contract in 2024 and <span>Save $1,000!</span></h2>
          <a href="#" class="landing-button">Get a Free Quote Today</a>
        </div>
        <div class="landing-hero__form">
          <h2 class="landing-hero__form-title">Smart tech, superior cleaning,and savings you’ll love.</h2>
          <div class="landing-hero__form-body">
            <script type="text/javascript" src="https://form.jotform.com/jsform/243375181808057"></script>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="landing-stat">
      <div class="landing-stat__container">
        <div class="landing-stat__item">
          <img src="/public/images/icon.svg" alt="" class="landing-stat__item-image" />
          <span class="landing-stat__item-desc">573</span>
          <span class="landing-stat__item-term">daily</span>
        </div>
        <div class="landing-stat__item">
          <img src="/public/images/icon2.svg" alt="" class="landing-stat__item-image" />
          <span class="landing-stat__item-desc">2,578</span>
          <span class="landing-stat__item-term">professionals</span>
        </div>
        <div class="landing-stat__item">
          <img src="/public/images/icon3.svg" alt="" class="landing-stat__item-image" />
          <span class="landing-stat__item-desc">99%</span>
          <span class="landing-stat__item-term">repeat</span>
        </div>
        <div class="landing-stat__item">
          <img src="/public/images/icon4.svg" alt="" class="landing-stat__item-image" />
          <span class="landing-stat__item-desc">17</span>
          <span class="landing-stat__item-term">years</span>
        </div>
      </div>
    </div>
    ...
    <section class="landing-cta">
      <div class="landing-cta__container landing-container">
        <div class="landing-cta__image">
          <img src="/public/images/deep-01-470x452.png" alt="" />
        </div>
        <div class="landing-cta__content">
          <h2>
            Focus on Your Business Growth While We Handle <br />
            the Cleaning
          </h2>
          <h3>Save Time and Resources with Our Expert Commercial Cleaning Solutions</h3>
          <p>Affordable pricing, unbeatable cleaning quality — revolutionized by our tech-savvy approach.</p>
          <a href="" class="landing-button">Get a Free Quote Today</a>
        </div>
      </div>
    </section>
    ...
    <section class="landing-services">
      <div class="landing-services__container landing-container">
        <div class="landing-services__header">
          <h2>Our Services</h2>
          <p>
            At Shen, we understand the importance of a clean and safe environment for the success and well-being of
            your business. With over 16 years of experience and a 99% repeat purchase rate, we are your trusted
            partner in maintaining pristine facilities.
          </p>
        </div>
        <div class="landing-services__list">
          <div class="landing-services__item">
            <img
              src="/public/images/people-taking-care-office-cleaning 1 (1).png"
              alt=""
              class="landing-services__item-image" />
            <h3 class="landing-services__item-title">Office Cleaning</h3>
          </div>
          <div class="landing-services__item">
            <img
              src="/public/images/people-taking-care-office-cleaning 1 (2).png"
              alt=""
              class="landing-services__item-image" />
            <h3 class="landing-services__item-title">Government Facilities Cleaning</h3>
          </div>
          <div class="landing-services__item">
            <img
              src="/public/images/people-taking-care-office-cleaning 1 (3).png"
              alt=""
              class="landing-services__item-image" />
            <h3 class="landing-services__item-title">Medical Office Cleaning</h3>
          </div>
          <div class="landing-services__item">
            <img
              src="/public/images/people-taking-care-office-cleaning 1 (1).png"
        ...
        <a href="" class="landing-services__link landing-button">Get a Free Quote Today</a>
      </div>
    </section>

    <section class="landing-expertise">
      <div class="landing-expertise__container landing-container">
        <h2 class="landing-expertise__title">Our expertise</h2>
    ...
    <section class="landing-rows">
      <div class="landing-rows__container landing-container">
        <h2 class="landing-rows__title">Why Choose Shen Innovative Cleaning?</h2>
        <div class="landing-rows__list" style="background-image: url(&quot;/public/images/steps.svg&quot;)">
          <div class="landing-rows__item">
            <div class="landing-rows__item-content">
              <h3>High Rise Condos & Condo Associations:</h3>
              <p>
                Our team provides meticulous cleaning services tailored to the unique needs of high-rise condos and
                condo associations, ensuring common areas and individual units are spotless and welcoming.
              </p>
            </div>
            <img src="/public/images/Frame 137.png" alt="" class="landing-rows__item-image" />
          </div>
          <div class="landing-rows__item">
            <div class="landing-rows__item-content">
              <h3>Trustworthy and Motivated Staff</h3>
              <p>Our reliable, background-checked team is trained to deliver exceptional results.</p>
            </div>
            <img src="/public/images/Frame 135.png" alt="" class="landing-rows__item-image" />
          </div>
          <div class="landing-rows__item">
            <div class="landing-rows__item-content">
              <h3>High Rise Condos & Condo Associations:</h3>
    ...
    <section class="landing-rewiews">
      <div class="landing-rewiews__container landing-container">
        <h2 class="landing-rewiews__title">Rewiews</h2>
            ...
            <div class="landing-rewiews__slide swiper-slide">
              <div class="landing-rewiews__slide-header">
                ...
                <div class="landing-rewiews__slide-info">
                  ...
                  <h3 class="landing-rewiews__slide-name">Marta</h3>
                </div>
              </div>
              <p class="landing-rewiews__slide-text">
                I ordered an office cleaning from Shen company. I have been using their services for several months
                now. Very satisfied. I recommend to all.
              </p>
              <p class="landing-rewiews__slide-date">December 6, 2024</p>
            </div>
            <div class="landing-rewiews__slide swiper-slide">
              <div class="landing-rewiews__slide-header">
                <svg
    ...
    <section class="landing-bottom">
      <div
        ...
        style="
              background-image: url(&quot;/public/images/cheerful-cleaner-moving-cart-with-cleaning-supplie-2024-11-19-13-35-07-utc\ 1.png&quot;);
            ">
        <div class="landing-bottom__content">
          <div class="landing-bottom__content-info">
            <h2><span>High-quality cleaning</span>, low-cost pricing—technology makes it possible!</h2>
            <p>
              Contact us today for a free consultation and discover <br />
              how Shen can make a difference.
            </p>
          </div>
          <div class="landing-bottom__content-contacts">
            <a href="#" class="landing-bottom__content-contact">
              <svg>
                <use href="/public/images/sprite/sprite.svg#phone"></use>
              </svg>
              <span>305-614-6480</span>
            </a>
            <div class="landing-bottom__content-contact">
              <svg>
                <use href="/public/images/sprite/sprite.svg#location"></use>
              </svg>
              <span>20900 NE 30th Ave, Aventura, FL 33180</span>
            </div>
            <a href="mailto:sales@shen-us.com" class="landing-bottom__content-contact">
              <svg>
                <use href="/public/images/sprite/sprite.svg#mail"></use>
              </svg>
              <span>sales@shen-us.com</span>
            </a>
          </div>
          <a href="#" class="landing-button">Get a Free Quote Today</a>
        </div>
